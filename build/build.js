...
fs.readFile( path.join( modules, 'es6-module-loader/dist/es6-module-loader.js' ), 'utf8', function( err, file ) {
    fs.writeFile( path.join( dist, 'common/es6-module-loader.js' ), file, 'utf8' );
});

fs.readFile( path.join( modules, 'systemjs/dist/system.js' ), 'utf8', function( err, file ) {
